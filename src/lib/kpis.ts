...
export const BOARDING_OCCUPANCY_CAPACITY_NIGHTS = 252;
...
export const KPI_SEGMENTS: KpiSegmentDef[] = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { key: "training_evaluations", label: "Training evaluations", section: "ACTUALS", format: "number" },
    ],
  },
  {
    key: "DAYCARE",
    label: "Daycare",
    metrics: [
      { key: "total_daycare_appointments", label: "Total Daycare Appointment", section: "ACTUALS", format: "number" },
