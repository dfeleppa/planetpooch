...
export default async function ScriptDetailPage({
  ...
  const script = await prisma.script.findUnique({
    ...
    include: {
      ...
      angle: {
        select: { id: true, name: true, emotionalRegister: true, audiencePocket: true },
      },
    ...
    <div className="w-full space-y-4">
      ...
      <ScriptEditor
        script={{
          ...
          onScreenTextStyle: script.onScreenTextStyle,
          musicTone: script.musicTone,
          lengthTarget: script.lengthTarget,
